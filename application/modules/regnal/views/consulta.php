<h1 class="titulo_seccion">Membresía Nacional</h1>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid" id="DataGrid" cols="4">
        ...
        ?>
            <tr>
              ...
              <td align="center"><a class="fancybox" href="<?php echo $site_base, 'regnal/ficha/', $this->miembro->id; ?>"><img src="<?php echo $site_root, 'img/onebit_39.png'; ?>" alt="Ficha" title="Ficha" width="16" height="16" border="0" align="absbottom" /></a></td>
                <td align="center"><a href="<?php echo $site_base, 'regnal/editar/', $this->miembro->id; ?>"><img src="<?php echo $site_root, 'img/onebit_20.png'; ?>" alt="Editar" title="Editar" width="16" height="16" border="0" align="absbottom" /></a></td>
            </tr>
        <?php
...
$(function() {
	...
	$('#Form').ajaxify({
				  ...
				  target:'#GridResults',
				  method:'POST',
				  link:'<?php echo ruta('regnal/grid'); ?>',
				  forms:'#Form',
				  loading_txt:'',
...
function load_pages(){
    ...
    $('#pagination').load('<?php  echo ruta('regnal/grid_pagination/'); ?>' + my_offset + '/' + my_total, function (){
		$('#pagination a').click(function(){
			var num = $(this).attr('href').split('/');
			$('#offset').val(num[1]);
			$('#Form').submit();
